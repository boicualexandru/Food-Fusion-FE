...
export const MAT_SLIDER_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => AvailabilitySliderComponent),
    multi: true
};
...
export class MatSliderChange {
    ...
    source: AvailabilitySliderComponent;
...
export class AvailabilitySliderComponent extends _MatSliderMixinBase
